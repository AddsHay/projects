...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    return ((FIRST_101_DIGITS_OF_PI // (pow(10, (101 - (score + 1))))) % 10) + 3
    # END PROBLEM 2
...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
       ...
       while ((player_score % x) != 0) or ((opponent_score % x) != 0):
          x = x - 1
       if x >= 10:
          return True
       else:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
       if who == 0:
          ...
          say = say(score0, score1)
          while extra_turn(score1, score0) and score1 < goal and score0 < goal:  
             num_rolls = strategy1(score1, score0)
             score1 = score1 + take_turn(num_rolls, score0, dice)
             say = say(score0, score1)
       who = abs(1 - who)
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while x <= 10:
       ...
       highest_scorex = avg_roll(x, dice)
       if highest_scorex > highest_score:
           highest_score = highest_scorex
           ans = x 
       x = x + 1
    return ans 
